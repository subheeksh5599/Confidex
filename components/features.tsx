...
const features: Feature[] = [
  {
    number: "01",
    title: "Explore the Wrappers Registry",
    description: "Browse every ERC-20 to ERC-7984 wrapper pair on Sepolia. All 7 mock token pairs at your fingertips with live on-chain data.",
    image: "/img/article-summary.webp",
  },
  {
    number: "02",
    title: "Shield and Unshield Tokens",
    description: "Wrap public ERC-20 tokens into confidential ERC-7984 form. Unwrap back anytime. FHE encryption keeps amounts private throughout.",
    image: "/img/research-papers.webp",
  },
  {
    number: "03",
    title: "Decrypt Confidential Balances",
    description: "View your encrypted token balances through EIP-712 signed decryption. Only you can see your balances — fully private by default.",
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6 max-w-sm text-base md:mb-8 md:text-lg">
            Confidex is the definitive terminal for interacting with the Zama
            Protocol Wrappers Registry on Sepolia testnet.
          </p>
          <a
            href="/dashboard"
