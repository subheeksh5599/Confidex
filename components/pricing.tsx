...
const plans: Plan[] = [
  {
    ...
    tagline: "Free testnet tokens for development",
    price: "$0",
    period: "forever",
    features: ["7 mock token pairs", "Built-in faucet", "Shield & unshield tokens", "Confidential balance decryption"],
  },
  {
    name: "Mainnet",
    tagline: "Live on Ethereum mainnet",
    price: "$40M+",
    period: "TVS",
    highlighted: true,
    features: ["cUSDC Morpho vault ($14M+)", "cUSDT, cWETH, cZAMA", "Institutional partners", "Production FHE security"],
  },
];
