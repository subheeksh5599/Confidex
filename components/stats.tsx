...
const stats = [
  { value: 40, suffix: "M+", label: "Total Value Shielded" },
  { value: 14, suffix: "M+", label: "cUSDC in Morpho Vault" },
  { value: 7, suffix: "", label: "Token Pairs on Sepolia" },
  { value: 3, suffix: "", label: "Bounty Tracks" },
];
