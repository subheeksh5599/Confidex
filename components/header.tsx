...
const menuCards = [
  {
    ...
    title: "PRODUCTS",
    links: [
      { label: "Dashboard", href: "/dashboard", badge: "NEW" },
      { label: "Zama Protocol", href: "https://zama.org", badge: null },
      { label: "Developer Docs", href: "https://docs.zama.org/protocol", badge: null },
    ],
  },
  {
    id: "resources",
