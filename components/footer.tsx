...
const productLinks = [
  ...
  { label: "Zama Protocol", href: "https://zama.org" },
  { label: "Developer Hub", href: "https://docs.zama.org/protocol" },
  { label: "Wrappers Registry", href: "https://eth-sepolia.blockscout.com/address/0x2f0750Bbb0A246059d80e94c454586a7F27a128e" },
];

const companyLinks = [
  { label: "GitHub", href: "https://github.com/subheeksh5599/Confidex" },
  { label: "Documentation", href: "https://docs.zama.org/protocol" },
  { label: "Discord", href: "https://discord.gg/zama" },
  { label: "Telegram", href: "https://t.me/zama_on_telegram" },
];

const socialLinks = [
  { label: "X", icon: TwitterIcon, href: "https://x.com/zama" },
  { label: "Discord", icon: LinkedInIcon, href: "https://discord.gg/zama" },
  { label: "GitHub", icon: GitHubIcon, href: "https://github.com/subheeksh5599/Confidex" },
];
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          <motion.div className="max-w-md" {...fadeInUp}>
            <p className="text-lg leading-relaxed text-black/80">
              Ready to explore confidential tokens? Confidex lets you shield, unshield, and decrypt
              confidential ERC-7984 tokens on the Zama Protocol Sepolia testnet.
            </p>
            <Link
               href="/dashboard"
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          <motion.div {...fadeInUp}>
            ...
            <p className="mt-8 text-sm text-black/50">
              Confidex - Zama Developer Program S3
            </p>
          </motion.div>
          ...
          <div className="flex flex-col justify-between gap-8 lg:items-end lg:text-right">
            <motion.div className="space-y-6" {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.1 }}>
              <div>
                <h4 className="mb-1 font-semibold">Sepolia Testnet</h4>
                <p className="text-black/70">
                  Zama Protocol Wrappers Registry
                  <br />
